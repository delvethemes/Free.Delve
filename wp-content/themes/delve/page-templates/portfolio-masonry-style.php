 ...
 *
 * The template for displaying masonry style portfolio
 *
 * @package WordPress
...
<section>
	<div id="portfolio-masonry" class="row container" <?php echo $d_cl['background']; ?>>
        ...
        <?php if( $data['portfolio-switch'] ): ?>
			...
			<div class="row portfolioContainer">
             ...
             <?php else:?>
            	<p>Please enable portfolio plguin from Plugins section and enable option from Delve Options > Home Settings</p>
            <?php endif;?>
		</div> <!-- .delve_content -->
