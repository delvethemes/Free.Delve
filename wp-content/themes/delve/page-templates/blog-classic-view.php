<?php
/**
 * Template Name: Blog Classic View
 *
 * The template for displaying blog/posts in classic view
 *
 * @package WordPress
...
<section>
	<div id="blog-classic" class="row container" <?php echo $d_cl['background']; ?>>
								...
								<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                                    ...
                                    <div class="entry-content">
                                         <?php
										 	...
										 	if( $columns == 'col-md-12 delve-col-1' ) {	$string = 500; }
											if( $columns == 'col-md-6 delve-col-2' ) { $string = 300; }
											if( $columns == 'col-md-4 delve-col-3' ) { $string = 200; }
											if( $columns == 'col-md-3 delve-col-4' ) { $string = 100; }
										 
										 echo substr(get_the_excerpt(), 0, $string ); ?> ...
                                    </div><!-- .entry-content -->
