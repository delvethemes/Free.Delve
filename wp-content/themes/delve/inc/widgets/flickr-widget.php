<?php
/**
 * The custom widget for displaying Flickr content
 *
 * @package WordPress
...
class Flickr_Widget extends WP_Widget {
	...
	function Flickr_Widget()
	{
		...
		$this->WP_Widget('flickr-widget', 'Delve: Flickr', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		function jsonFlickrApi(rsp) {
			...
			for (var i=0; i < rsp.photos.photo.length; i++) {
				...
				s +=  '<div class="flickr_badge_image"><a href="' + p_url + '">' + '<img alt="'+ photo.title + '"src="' + t_url + '"/>' + '</a></div>';
			}
	...
	function form($instance)
	{
		...
		<p>
			<label for="<?php echo $this->get_field_id('api'); ?>">API key (Use default or get your own from <a href="https://www.flickr.com/services/apps/create/apply">Flickr APP Garden</a>):</label>
