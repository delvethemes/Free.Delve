<?php
/**
 * The custom widget for displaying facebook content
 *
 * @package WordPress
...
class Facebook_Like_Widget extends WP_Widget {
	...
	function Facebook_Like_Widget()
	{
		...
		$this->WP_Widget('facebook-like-widget', 'Delve: Facebook Like Box', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		if($page_url): ?>
		<iframe src="http://www.facebook.com/plugins/likebox.php?href=<?php echo urlencode($page_url); ?>&amp;width=<?php echo $width; ?>&amp;colorscheme=<?php echo $color_scheme; ?>&amp;show_faces=<?php echo $show_faces; ?>&amp;stream=<?php echo $show_stream; ?>&amp;header=<?php echo $show_header; ?>&amp;height=<?php echo $height; ?>&amp;force_wall=true<?php if($show_faces == 'true'): ?>&amp;connections=8<?php endif; ?>" scrolling="no" frameborder="0" style="border:none;max-width:100%; overflow:hidden; width:<?php echo $width; ?>px; height: <?php echo $height; ?>px;" allowTransparency="true"></iframe>
		<?php endif;
