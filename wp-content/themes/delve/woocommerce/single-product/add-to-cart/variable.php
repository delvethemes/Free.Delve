	...
	<?php if ( ! empty( $available_variations ) ) : ?>
		...
		<div class="single_variation_wrap" style="display:none;">
			...
			<div class="variations_button">
				...
				<button id="hover-icon-add-to-cart" type="submit" 
                	class="single_add_to_cart_button eff-btn hover-icon normal top-to-bottom">
                    <span class="ss-icon-on-hover"><i class="fa fa-shopping-cart"></i></span><span>
